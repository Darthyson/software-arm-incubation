 ...
 * generated with KNXprodEditor 0.39
 * 
 * Format: 
 ...
 *
 * Geräteinformationen:
 * Device: AKD-0424R.02 LED Controller 4 Ch/RGBW, MDRC
 * ApplicationProgram: M-0083_A-0040-24-1835
 *
 */
...
const byte hardwareVersion[6] = { 0x00, 0x00, 0x00, 0x00, 0x03, 0x40 }; //!< The hardware identification number hardwareVersion
